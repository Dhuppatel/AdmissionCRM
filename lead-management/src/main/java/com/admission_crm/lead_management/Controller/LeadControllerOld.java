...
//
//    @PostMapping
//    public ResponseEntity<?> createLead(@RequestBody LeadRequest lead) {
//
//        try {
//            Lead newLead = leadService.createLead(lead, lead.getFirstName());
//            return ResponseEntity.status(HttpStatus.CREATED)
//                    .body(ApiResponse.success("Lead created successfully", LeadResponse.fromEntity(newLead)));
