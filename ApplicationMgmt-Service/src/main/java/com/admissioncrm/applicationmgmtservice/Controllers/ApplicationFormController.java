...
import com.admissioncrm.applicationmgmtservice.Exception.DuplicateApplicationException;
...
//    }
    ...
    public ResponseEntity<?> getAllApplications() {
        ...
        List<CreateApplicationResponseDTO> response=applicationFormService.getMyApplications();
    ...
    @PostMapping(value = "/draft/{applicationId}",
            consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<ApplicationResponseDTO> saveDraft(
        ...
        try {
            ...
            try {
                applicationDTO = objectMapper.readValue(
                        applicationDataJson,
                        ApplicationFormSubmissionDTO.class);
    ...
    @PostMapping(value = "/submit/{applicationId}",
            consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<ApplicationResponseDTO> submitApplication(
        ...
        try {
            ...
            ApplicationResponseDTO response =
                    applicationFormService.submitApplication(
                            applicationId,
                            applicationDTO,
                            documents);
...
//    }
    ...
    public ResponseEntity<ApiResponse<ApplicationFormFullResponseDTO>>
    getApplicationForm(@PathVariable String applicationId) {

        try {
            ApplicationFormFullResponseDTO response =
                    applicationFormService.getApplicationById(applicationId);

            return ResponseEntity.ok(
                    ApiResponse.success("Application fetched successfully", response)
            );
